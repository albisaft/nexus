                    ...
                    if (((zielfeld = Feld[Stufe][ziel]) != RAND))   {
                        if (zielfeld != LEER)   { // schraeg schlagen
                            ...
                            if (zielfeld / abs(zielfeld) != farbvorzeichen)   {
                                ...
                                add_zug(pos1, pos2, n, true, figur, materialwert[abs(zielfeld)]-materialwert[abs(figur)]*0.1); } } } } //Bauer endet hier
...
inline double entwicklung(int feld[120], int farbe)    {
    ...
    for (int i = 21; i <= 98; i++)  {
        ...
        if (feld[i] == __STARTFELD[i]) {
            if (Freibauer_Array[i % 10] == 1
                && (Freibauer_Array[i % 10 - 1] == 0 || Freibauer_Array[i % 10 - 1] == 1)
                && (Freibauer_Array[i % 10 + 1] == 0 || Freibauer_Array[i % 10 + 1] == 1))
               {
                 wertung += 2 * __STARTPUNKTE[i] + FreibauernBonus * (i / 10 % 10 - 1);
               }
            else
        ...
        if (feld[i] == __STARTFELDx[i]) {
           if (Freibauer_Array[i % 10] == -1
               && (Freibauer_Array[i % 10 - 1] == 0 || Freibauer_Array[i % 10 - 1] == -1)
               && (Freibauer_Array[i % 10 + 1] == 0 || Freibauer_Array[i % 10 + 1] == -1))
                  wertung -= 2 * __STARTPUNKTEx[i] + FreibauernBonus * (8 - i / 10 % 10);
            else
                wertung -= 2 * __STARTPUNKTEx[i]; }                                  // -kingzone_gegner[i]*10;//-kingzone_ich[i]*10;	//4.1
        ...
        if (feld[i] == __STARTFELDx10[i])
            wertung +=  (figurenwert-4100)*0.001*__STARTPUNKTEx10[i];  // +kingzone_ich[i]*10;	//1.17
...
//   if (figur<0) figurenwert_schwarz += abs(figur) * materialwert[abs(figur)];
        ...
        if (abs(figur)==W_B||abs(figur)==W_Bx) {
            if (Freibauer_Array[i % 10] == 0)
                {Freibauer_Array[i % 10] = figur/abs(figur);continue;}
            if (Freibauer_Array[i % 10] == -figur/abs(figur))
                Freibauer_Array[i % 10] = 2; }
    ...
    //cout << Freibauer_Array[0] << Freibauer_Array[1] << Freibauer_Array[2] << Freibauer_Array[3] << Freibauer_Array[4] << Freibauer_Array[5] << Freibauer_Array[6] << Freibauer_Array[7] << "\n";
        ...
        if ((figur == W_D)) {
            ...
            for (int richtung = 0; richtung <= bewegung[figur][0]; richtung++)  {
                for (int weite = 0; weite <= bewegung[figur][1]; weite++)  {
                    ...
                    if (farbvorzeichen == _eigene_farbe) zugzone_ich[pos2] += 10;
                    else zugzone_du[pos2] += 10;
                    ...
                    if (zielfeld != LEER)  {
                        ...
                        if (farbvorzeichen != _eigene_farbe)  {
                            if (zielfeld / _eigene_farbe > 0) {                // Gegner greift meine Figur an
                                ...
                                if (abs(zielfeld) < 6)
                                    Attack_Dame -= DefIch2; } // Gegner deckt seine Figuren
                            ...
                            if (zielfeld / _eigene_farbe < 0) {                     // Ich greife Gegner an
                                ...
                                if (abs(zielfeld) < 6)
                                    Attack_Dame -= DefEr2; } } // Ich decke meine Figuren
                        break; }
            ...
            for (int richtung = 0; richtung <= bewegung[figur][0]; richtung++)  {
                for (int weite = 0; weite <= bewegung[figur][1]; weite++)  {
                    ...
                    /*    for (int richtung = 0; richtung <= bewegung[W_K][0]; richtung++)
                       ...
                       int zielfeldk = feld[pos2];
                       if (zielfeld == zielfeldk) n -= 400*farbvorzeichen;return n;}}*/
                    if (farbvorzeichen == _eigene_farbe) zugzone_ich[pos2] += 100;
                    else zugzone_du[pos2] += 100;
                    if (kingzone[pos2] == -farbvorzeichen) {
                        if (farbvorzeichen == _eigene_farbe) {
                            if (farbvorzeichen == 1) {
                    ...
                    if (zielfeld != LEER)  {
                        ...
                        if (farbvorzeichen != _eigene_farbe)  {
                            if (zielfeld / _eigene_farbe > 0) { // Gegner greift meine Figur
                                ...
                                if (abs(zielfeld) < 6)
                                    Attack_Turm -= DefIch2; } // Gegner deckt seine Figuren
                            ...
                            if (zielfeld / _eigene_farbe < 0) {                     // Ich greife Gegner an
                                ...
                                if (abs(zielfeld) < 6)
                                    Attack_Turm -= DefEr2; } } // Ich decke meine Figuren
                        break; }
                    ...
                    if (farbvorzeichen != _eigene_farbe)  {
                        ...
                        if ((n_Turm > 10) && (n_Turm < 14))
                            n_Turm += 1; } } } n_Turm *= farbvorzeichen; Attack_Turm *= farbvorzeichen;
            ...
            for (int richtung = 0; richtung <= bewegung[figur][0]; richtung++)  {
                for (int weite = 0; weite <= bewegung[figur][1]; weite++)  {
                    ...
                    /*    for (int richtung = 0; richtung <= bewegung[W_K][0]; richtung++)
                       ...
                       int zielfeldk = feld[pos2];
                       if (zielfeld == zielfeldk) n -= 400*farbvorzeichen;return n;}}*/
                    if (farbvorzeichen == _eigene_farbe) zugzone_ich[pos2] += 1000;
                    else zugzone_du[pos2] += 1000;
                    if (kingzone[pos2] == -farbvorzeichen) {
                        if (farbvorzeichen == _eigene_farbe) {
                            if (farbvorzeichen == 1) {
                    ...
                    if (zielfeld != LEER)  {
                        ...
                        if (farbvorzeichen != _eigene_farbe)  {
                            ...
                            if (zielfeld / _eigene_farbe < 0) {                        // Ich
                                ...
                                if (abs(zielfeld) < 6)
                                    Attack_Laeufer -= DefEr2; } } // Ich decke meine Figuren
                        break; }
                    ...
                    if (farbvorzeichen != _eigene_farbe)  {
                        ...
                        if (n_Laeufer > 21)
                            n_Laeufer += 1; } } } n_Laeufer *= farbvorzeichen; Attack_Laeufer *= farbvorzeichen;
                    ...
                    if (zielfeld != LEER)  {
                        ...
                        if (farbvorzeichen != _eigene_farbe)  {
                            if (zielfeld / _eigene_farbe > 0) { // Gegner greift meine Figur
                                ...
                                if (abs(zielfeld) < 6)
                                    Attack_Pferd -= DefIch2; } // Gegner deckt seine Figuren 1
                        }
                        else  {
                            if (zielfeld / _eigene_farbe < 0) {                      // Ich greife Gegner an
                                if (schlagzone_ich[pos2] != 1)
                                ...
                                if (abs(zielfeld) < 6)
                                    Attack_Pferd -= DefEr2; } } // Ich decke meine Figuren
                        break; }
...
//       if (kingzone[i] == 1) Attack_Bauer += KSafety;
                    if (farbvorzeichen == _eigene_farbe) zugzone_ich[pos2] += 10000;
                    else zugzone_du[pos2] += 10000;
                    if (zielfeld != LEER)  {
                        int zielfigur = abs(zielfeld);
        ...
        if (((figur == W_K) || (figur == W_Kr))) {
            ...
            for (int richtung = 0; richtung <= bewegung[figur][0]; richtung++)  {
                for (int weite = 0; weite <= bewegung[figur][1]; weite++)  {
                    ...
                    if (zielfeld == RAND) // Aus!
                        break;
                    if (farbvorzeichen == _eigene_farbe) zugzone_ich[pos2] += 1;
                    else zugzone_du[pos2] += 1;
                    if (zielfeld != LEER)  {
                        int zielfigur = abs(zielfeld);
...
/* }
 ...
 /*for (int l = 0; l < 200; l++)using namespace std;
